 ...
 */
const initiateRegisterVerifyAadhaarDigilockerSession = async ({
  mobileNumber,
  domainName,
  aadhaarNumber,
 ...
 */
const checkRegisterVerifyAadhaarDigilockerSession = async ({
  mobileNumber,
  domainName,
  aadhaarNumber,
}) => {
 ...
 */
const getOrderDeliveryStatusByBillId = async (billId) => {
  try {
    if (
      billId === undefined ||
      billId === null ||
